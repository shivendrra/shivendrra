      ...
      <div className='lander'>
        <div className="container">
          ...
          <div className='mainSec row text-center'>
            ...
            <div className="col-lg-12 links d-flex">
              <div className="col-lg-3 col-sm-6 text-center" onClick={() => handleClick('https://github.com/shivendrra/')}>
              ...
              <div className="col-lg-3 col-sm-6 text-center" onClick={() => handleClick("https://www.linkedin.com/in/shivendrra/")}>
              ...
              <div className="col-lg-3 col-sm-6 text-center" onClick={() => handleClick("https://x.com/shivendrra_")}>
              ...
              <div className="col-lg-3 col-sm-6 text-center" onClick={() => handleClick("https://instagram.com/shivendrra_")}>
          ...
          <hr className='mainHr' />
          <div className="yt-show mt-4 mx-0">
            <Youtube />
          </div>
          <div className="workSec row mt-2 mx-0">
            <h4 className='pb-5 px-5'>Experience</h4>
            <Exp />
            <hr style={{ width: '60%', margin: 'auto', padding: '1% 0%' }} />
            <h4 className='pt-5 px-5'>Coding Projects</h4>
            <Proj />
          </div>
        </div>
        <Footer />
